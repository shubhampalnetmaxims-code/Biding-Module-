    ...
    return (
        <>
            <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50" onClick={onClose}>
                <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg m-4 flex flex-col max-h-[90vh]" onClick={(e) => e.stopPropagation()}>
                    <div className="p-5 border-b border-slate-200 flex justify-between items-center">
                        <h3 className="text-xl font-bold text-slate-900">{booth.title} <span className="text-base font-medium text-slate-500">({booth.type} - {booth.size})</span></h3>
                            ...
                            <div className="space-y-3">
                                {userBidDetails && (
                                    <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg text-sm">
                                        ...
                                        {!hasAnyPendingBuyout && (
                                            <div className="mt-2 pt-2 border-t border-blue-200"><button onClick={handleRemoveBid} className="w-full text-center text-xs font-semibold text-red-600 hover:text-red-800 hover:bg-red-50 py-1 rounded-md transition-colors">Remove Bid</button></div>
                                        )}
                                    </div>
                                )}
